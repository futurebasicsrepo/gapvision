/**
 * The Cue Bracket   —   SOURCE: packages/brand/Mark.jsx
 *
 * Copies of this file under each app's src/components/ are GENERATED by
 * `npm run brand:sync`. Edit it here; edit it anywhere else and the next
 * sync reverts you.
 *
